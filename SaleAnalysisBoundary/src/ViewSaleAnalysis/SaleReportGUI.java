 ...
 * @author Admin
 */
public class SaleReportGUI extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SaleReportGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
